...
namespace ult {
    ...
    const std::string BASE_CONFIG_PATH   = ROOT_PATH + "config/breezehand/";
    ...
    const std::string HB_APPSTORE_JSON            = SWITCH_PATH + "appstore/.get/packages/BreezehandOverlay/info.json";
    ...
    CONSTEXPR_STRING std::string WARNING_SYMBOL      = "";
